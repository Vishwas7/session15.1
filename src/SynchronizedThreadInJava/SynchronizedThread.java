package SynchronizedThreadInJava;
 ...
 * to show the difference output using synchronized  keyword, so i'm using
 * synchronized  keyword in  this code.
 * 
 */
...
class Customer implements Runnable {
	...
	public void run(){
		...
		/**
		 * In here using synchronized keyword
		 * Synchronization keyword  is  capable 
		 * to control the access of multiple threads to any shared resource 
		 * and in this program shared resource is account so
		 * passing account in synchronized for access any 
...
/**
 * created class SynchronizedThread and main method 
